...
class CRMPlugin(models.Model):
	...
	m_company_name = fields.Char(related="partner_id.name", store=False)
	m_contact = fields.Many2one('res.partner', domain="[('parent_name', '=', 'm_company_name')]", string="Contact de la société")
